...
const rcModule = require('gremlin/lib/driver/remote-connection');
 ...
 */
class WebDriverRemoteConnection extends RemoteConnection {
  ...
  constructor(url, options) {
    super(url);
    this._client = new WebClient(url, options);
  }
...
module.exports = WebDriverRemoteConnection;
